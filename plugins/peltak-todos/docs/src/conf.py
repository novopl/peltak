...
html_theme_options = {
    ...
    'nav_title': 'peltak-todos',
    # Set you GA account ID to enable tracking
    'google_analytics_account': 'UA-187740680-1',
    # Specify a base_url used to generate sitemap.xml. If not
    # specified, then no sitemap will be built.
    'base_url': 'https://novopl.github.io/peltak-todos',
    # Set the color and the accent color
    'color_primary': 'light-green',
    'color_accent': 'amber',
    # Set the repo location to get a badge with stats
    'repo_url': 'https://github.com/novopl/peltak-todos',
    'repo_name': 'peltak-todos',
    'logo_icon': '&#x267E',
...
# = other ======================================================================
htmlhelp_basename = 'peltak-todos'
latex_elements = {}
latex_documents = [
    (master_doc, 'peltak-todos.tex', 'peltak-todos Documentation',
     'Mateusz \'novo\' Klos', 'manual'),
]
man_pages = [
    (master_doc, 'peltak-todos', 'peltak-todos Documentation', [author], 1)
]
texinfo_documents = [
    (master_doc, 'peltak-todos', 'peltak-todos Documentation',
     author, 'peltak-todos', 'One line description of project.',
     'Miscellaneous'),
]
